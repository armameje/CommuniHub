  ...
  return (
    <section className="w-fill h-auto bg-[rgb(250,236,225)] flex flex-col justify-center items-center gap-4 py-16">
      ...
      <div className="relative">
          ...
          <Link href="/news" className="w-[800px] h-[450px] bg-[rgb(250,236,225,0.1)] text-white py-2 px-4 hover:bg-[rgb(250,236,225,0.2)] hover:text-green-950 transition-all z-10 absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%]">
            Services
          </Link>
      </div>
    </section>
