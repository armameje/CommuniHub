export default function Map() {
  return (
    <section className="w-auto h-auto flex flex-col items-center justify-center px-52">
      ...
      <div className="map-bg w-full h-[416px] relative">
        ...
        <div className="w-[88px] h-[38px] bg-[rgb(250,236,225)] absolute top-[58%] left-[39%] rotate-[-10deg]"></div>
        <div className="w-[40px] h-[40px] bg-[rgb(250,236,225)] absolute top-[10%] left-[63%] rotate-[-8deg]"></div>
        <div className="w-[55px] h-[55px] bg-[rgb(250,236,225)] absolute top-[14%] left-[78%] rotate-[-8deg]"></div>
        <div className="w-[55px] h-[55px] bg-[rgb(250,236,225)] absolute top-[50%] left-[79%] rotate-[-8deg]"></div>
      </div>
    </section>
  );
}
