...
export default async function Help() {
  ...
  return (
    <><section>
      <div className="w-auto h-auto flex flex-col item-center justify-center gap-5 bg-[rgb(250,236,225)] pb-10">
    ...
    <section className="w-auto h-auto bg-[rgb(250,236,225)] flex flex-col justify-center items-center px-48 py-20 gap-8">
      <div className="flex gap-5">
        <div className="relative">
          <div className="w-[1100px] h-[700px] flex justify-center items-center FAQs bg-cover bg-center"></div>
        </div>
      </div>
    </section>
    <Footer></Footer>
